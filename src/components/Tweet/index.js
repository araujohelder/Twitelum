...
class Tweet extends Component {
    ...
    likeHandle = () => {
        ...
        fetch(`https://twitelum-api.herokuapp.com/tweets/${this.props.tweetInfo._id}/like?X-AUTH-TOKEN=${localStorage.getItem('TOKEN')}`,{ method: 'POST' })
        ...
        return (
            <article className="tweet">
                ...
                <footer className="tweet__footer">
                    <button className=" btnLike btn btn--clean" onClick={this.likeHandle} >
